...
_8-11 are imp_
**** Basic Terminology
- Mass : the quantity of matter possed by a body is called mass.
- Time : The time is the measure of succession of events
- Space : The geometric region in which study of body is involved is called space.
- Length : It is concept to measure linear distances
- Displacement - distance moved by a particle in a specified direction
- Velocity: The rate of change of Displacement with respect to time.
- Acceleration: Rate of change of velocity with respect to time.
- Momentum: Product of mass and velocity
- Continumm: Continuous Distribution of matter
- Rigit Body: A body is said to be rigit if the relative positions of any two particles do not change under the action of the forces acting on it.
